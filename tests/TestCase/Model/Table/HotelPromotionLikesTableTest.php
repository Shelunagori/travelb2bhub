...
use App\Model\Table\HotelPromotionLikesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\HotelPromotionLikesTable Test Case
 */
class HotelPromotionLikesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\HotelPromotionLikesTable
     */
    public $HotelPromotionLikes;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('HotelPromotionLikes') ? [] : ['className' => 'App\Model\Table\HotelPromotionLikesTable'];
        $this->HotelPromotionLikes = TableRegistry::get('HotelPromotionLikes', $config);
    }
    ...
    {
        unset($this->HotelPromotionLikes);
