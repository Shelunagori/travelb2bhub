...
use App\Model\Table\TaxiFleetPromotionReportsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TaxiFleetPromotionReportsTable Test Case
 */
class TaxiFleetPromotionReportsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TaxiFleetPromotionReportsTable
     */
    public $TaxiFleetPromotionReports;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TaxiFleetPromotionReports') ? [] : ['className' => 'App\Model\Table\TaxiFleetPromotionReportsTable'];
        $this->TaxiFleetPromotionReports = TableRegistry::get('TaxiFleetPromotionReports', $config);
    }
    ...
    {
        unset($this->TaxiFleetPromotionReports);
