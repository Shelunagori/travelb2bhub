...
use App\Model\Table\TaxiFleetPromotionCartsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TaxiFleetPromotionCartsTable Test Case
 */
class TaxiFleetPromotionCartsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TaxiFleetPromotionCartsTable
     */
    public $TaxiFleetPromotionCarts;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TaxiFleetPromotionCarts') ? [] : ['className' => 'App\Model\Table\TaxiFleetPromotionCartsTable'];
        $this->TaxiFleetPromotionCarts = TableRegistry::get('TaxiFleetPromotionCarts', $config);
    }
    ...
    {
        unset($this->TaxiFleetPromotionCarts);
