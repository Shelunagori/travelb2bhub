...
use App\Model\Table\PostTravlePackagePriceBeforeRenewsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PostTravlePackagePriceBeforeRenewsTable Test Case
 */
class PostTravlePackagePriceBeforeRenewsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PostTravlePackagePriceBeforeRenewsTable
     */
    public $PostTravlePackagePriceBeforeRenews;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PostTravlePackagePriceBeforeRenews') ? [] : ['className' => 'App\Model\Table\PostTravlePackagePriceBeforeRenewsTable'];
        $this->PostTravlePackagePriceBeforeRenews = TableRegistry::get('PostTravlePackagePriceBeforeRenews', $config);
    }
    ...
    {
        unset($this->PostTravlePackagePriceBeforeRenews);
