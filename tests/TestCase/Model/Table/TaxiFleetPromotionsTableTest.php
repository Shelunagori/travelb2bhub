...
class TaxiFleetPromotionsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TaxiFleetPromotions') ? [] : ['className' => 'App\Model\Table\TaxiFleetPromotionsTable'];
        $this->TaxiFleetPromotions = TableRegistry::get('TaxiFleetPromotions', $config);
    }
