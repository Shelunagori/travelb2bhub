...
use App\Model\Table\PostTravlePackageViewsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PostTravlePackageViewsTable Test Case
 */
class PostTravlePackageViewsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PostTravlePackageViewsTable
     */
    public $PostTravlePackageViews;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PostTravlePackageViews') ? [] : ['className' => 'App\Model\Table\PostTravlePackageViewsTable'];
        $this->PostTravlePackageViews = TableRegistry::get('PostTravlePackageViews', $config);
    }
    ...
    {
        unset($this->PostTravlePackageViews);
