...
use App\Model\Table\HotelPromotionCartsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\HotelPromotionCartsTable Test Case
 */
class HotelPromotionCartsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\HotelPromotionCartsTable
     */
    public $HotelPromotionCarts;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('HotelPromotionCarts') ? [] : ['className' => 'App\Model\Table\HotelPromotionCartsTable'];
        $this->HotelPromotionCarts = TableRegistry::get('HotelPromotionCarts', $config);
    }
    ...
    {
        unset($this->HotelPromotionCarts);
