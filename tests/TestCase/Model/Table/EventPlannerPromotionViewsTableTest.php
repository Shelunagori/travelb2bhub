...
use App\Model\Table\EventPlannerPromotionViewsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EventPlannerPromotionViewsTable Test Case
 */
class EventPlannerPromotionViewsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\EventPlannerPromotionViewsTable
     */
    public $EventPlannerPromotionViews;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EventPlannerPromotionViews') ? [] : ['className' => 'App\Model\Table\EventPlannerPromotionViewsTable'];
        $this->EventPlannerPromotionViews = TableRegistry::get('EventPlannerPromotionViews', $config);
    }
    ...
    {
        unset($this->EventPlannerPromotionViews);
