...
class HotelPromotionsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('HotelPromotions') ? [] : ['className' => 'App\Model\Table\HotelPromotionsTable'];
        $this->HotelPromotions = TableRegistry::get('HotelPromotions', $config);
    }
