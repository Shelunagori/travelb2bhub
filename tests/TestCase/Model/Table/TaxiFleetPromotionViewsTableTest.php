...
use App\Model\Table\TaxiFleetPromotionViewsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TaxiFleetPromotionViewsTable Test Case
 */
class TaxiFleetPromotionViewsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TaxiFleetPromotionViewsTable
     */
    public $TaxiFleetPromotionViews;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TaxiFleetPromotionViews') ? [] : ['className' => 'App\Model\Table\TaxiFleetPromotionViewsTable'];
        $this->TaxiFleetPromotionViews = TableRegistry::get('TaxiFleetPromotionViews', $config);
    }
    ...
    {
        unset($this->TaxiFleetPromotionViews);
