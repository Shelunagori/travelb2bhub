...
use App\Model\Table\ReportReasonsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ReportReasonsTable Test Case
 */
class ReportReasonsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ReportReasonsTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ReportReasons') ? [] : ['className' => 'App\Model\Table\ReportReasonsTable'];
        $this->ReportReasons = TableRegistry::get('ReportReasons', $config);
    }
