...
use App\Model\Table\PostTravlePackageReportsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PostTravlePackageReportsTable Test Case
 */
class PostTravlePackageReportsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PostTravlePackageReportsTable
     */
    public $PostTravlePackageReports;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PostTravlePackageReports') ? [] : ['className' => 'App\Model\Table\PostTravlePackageReportsTable'];
        $this->PostTravlePackageReports = TableRegistry::get('PostTravlePackageReports', $config);
    }
    ...
    {
        unset($this->PostTravlePackageReports);
