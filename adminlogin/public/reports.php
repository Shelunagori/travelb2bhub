...
<div class="loading" style="display: none;">
    ...
    <div class="row">
		...
		<form method="post" action="user-report.php">	
			<div class="col-sm-12"><a class="btn btn-primary" href="request-report.php" role="button">List of all the Removed Requests that were removed and had not received any responses</a></div>	
			
			<div class="col-sm-6" style="margin-top:20px;"><a class="btn btn-primary" href="user-report.php" role="button">List of all the users who have not logged into the system for more than</a>
			</div>	
				<div class="col-sm-3" style="margin-top:20px;">
				<select name="login_days" id="login_days" class="form-control">
			...
			<div class="col-sm-3" style="margin-top:20px;">
			<a class="btn btn-primary" id="userreport" href="user-report.php?login_days=15" role="button">Submit</a>
			</div>
		</form>
			</div>
		</div>
	...
	<script>
	$("#login_days").click(function () {
	var logindays = this.value;
		$("#userreport").attr("href", "user-report.php?login_days="+logindays)
	});
	</script>
</body>
</html>