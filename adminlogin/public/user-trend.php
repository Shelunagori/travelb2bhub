...
if($time_interval==2){
	...
	for($m=1;$m<=12;$m++)
		{
		$sql = "SELECT COUNT(*) as total_count from users as u $where AND u.`create_at` BETWEEN '$current_year-$m-01' AND '$current_year-$m-31'";
		$res= mysql_query($sql,$connection);
		$row = mysql_fetch_assoc($res);
		$total_count = $row['total_count'];	
		$total_count_data.= $total_count.",";
			
		$sqlt = "SELECT COUNT(*) as ta_count from users as u $where AND u.`create_at` BETWEEN '$current_year-$m-01' AND '$current_year-$m-31' AND u.role_id=1";
		...
		//For Event planner
		$sqle = "SELECT COUNT(*) as ep_count from users as u $where AND u.`create_at` BETWEEN '$current_year-$m-01' AND '$current_year-$m-31' AND u.role_id=2";
		$rese = mysql_query($sqle,$connection);
		$rowe = mysql_fetch_assoc($rese);
		$ep_count = $rowe['ep_count'];
		$e_p_count_data.= $ep_count.",";
			
		$sqlh = "SELECT COUNT(*) as ht_count from users as u $where AND u.`create_at` BETWEEN '$current_year-$m-01' AND '$current_year-$m-31' AND u.role_id=3";
		$resh = mysql_query($sqlh,$connection);
		$rowh = mysql_fetch_assoc($resh);
		$ht_count = $rowh['ht_count'];
		$h_t_count_data.= $ht_count.",";	
		}
	...
	$h_t_count_string = rtrim($h_t_count_data,',');
	$h_t_count_data = $h_t_count_string."]";
...
}elseif($time_interval==3)
{
	...
	{
	 	$sql = "SELECT COUNT(*) as total_count from users as u $where AND u.`create_at` BETWEEN '$start_year-01-01' AND '$start_year-12-31'";
		$res= mysql_query($sql,$connection);
		$row = mysql_fetch_assoc($res);
		$total_count = $row['total_count'];	
		$total_count_data.= $total_count.",";
		
		$sqlt = "SELECT COUNT(*) as ta_count from users as u $where AND u.`create_at` BETWEEN '$start_year-01-01' AND '$start_year-12-31' AND u.role_id=1";
		$rest = mysql_query($sqlt,$connection);
		$rowt = mysql_fetch_assoc($rest);
		$ta_count = $rowt['ta_count'];
		$t_a_count_data.= $ta_count.",";
		...
		//For Event planner
		$sqle = "SELECT COUNT(*) as ep_count from users as u $where AND u.`create_at` BETWEEN '$start_year-01-01' AND '$start_year-12-31' AND u.role_id=2";
		$rese = mysql_query($sqle,$connection);
		$rowe = mysql_fetch_assoc($rese);
		$ep_count = $rowe['ep_count'];
		$e_p_count_data.= $ep_count.",";
		
		$sqlh = "SELECT COUNT(*) as ht_count from users as u $where AND u.`create_at` BETWEEN '$start_year-01-01' AND '$start_year-12-31' AND u.role_id=3";
		$resh = mysql_query($sqlh,$connection);
		$rowh = mysql_fetch_assoc($resh);
		$ht_count = $rowh['ht_count'];
		$h_t_count_data.= $ht_count.",";
...
$categories = $year_string;
	...
	for($d=1;$d<=$total_day;$d++)
		{
		$sql = "SELECT COUNT(*) as total_count from users as u $where AND u.`create_at` BETWEEN '$current_year-$m-$d' AND '$current_year-$m-$d 23:59:00'";
		$res= mysql_query($sql,$connection);
		$row = mysql_fetch_assoc($res);
		$total_count = $row['total_count'];	
		$total_count_data.= $total_count.",";
			
		$sqlt = "SELECT COUNT(*) as ta_count from users as u $where AND u.`create_at` BETWEEN '$current_year-$m-$d' AND '$current_year-$m-$d 23:59:00' AND u.role_id=1";
		$rest = mysql_query($sqlt,$connection);
		$rowt = mysql_fetch_assoc($rest);
		$ta_count = $rowt['ta_count'];
		$t_a_count_data.= $ta_count.",";
		...
		//For Event planner
		$sqle = "SELECT COUNT(*) as ep_count from users as u $where AND u.`create_at` BETWEEN '$current_year-$m-$d' AND '$current_year-$m-$d 23:59:00' AND u.role_id=2";
		$rese = mysql_query($sqle,$connection);
		$rowe = mysql_fetch_assoc($rese);
		$ep_count = $rowe['ep_count'];
		$e_p_count_data.= $ep_count.",";
			
		$sqlh = "SELECT COUNT(*) as ht_count from users as u $where AND u.`create_at` BETWEEN '$current_year-$m-$d' AND '$current_year-$m-$d 23:59:00' AND u.role_id=3";
		$resh = mysql_query($sqlh,$connection);
		$rowh = mysql_fetch_assoc($resh);
		$ht_count = $rowh['ht_count'];
		$h_t_count_data.= $ht_count.",";
...
<a href="<?php echo $siteurl;?>adminlogin/public/user-record.php" class="btn btn-default">reset</a>
</form>
</div>
