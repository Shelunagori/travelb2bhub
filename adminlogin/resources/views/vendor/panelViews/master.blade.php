...
<head>
    ...
    <title>{{isset($title) ? ucfirst($title) : 'Panel'}}</title>
    <!-- compiled styles -->
    ...
    <script src="{{asset("packages/serverfireteam/panel/js/jquery-1.11.0.js")}}"></script>
	 <link href="{{asset("packages/zofe/rapyd/assets/select2/select2.css")}}" rel="stylesheet" type="text/css">
	<script src="{{asset("packages/zofe/rapyd/assets/select2/select2.js")}}"></script>
</head>

<body class="@yield('bodyClass') {{isset($title) ? ucfirst($title) : 'Panel'}}">
    @yield('body')
    <!-- /#wrapper -->
    ...
    {!! Rapyd::scripts() !!}
<script src="{{asset("packages/zofe/rapyd/assets/select2/custom.js")}}"></script>	
</body>
