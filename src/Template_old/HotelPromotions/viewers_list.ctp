...
curl_setopt_array($curl, array(
  CURLOPT_URL => $coreVariable['SiteUrl']."api/hotel_promotions/HotelPromotionsViews.json?hotel_promotion_id=".$hotelpromotion_id."&user_id=".$user_id,
...
if ($err) {
  echo "cURL Error #:" . $err;
	...
	//pr($List); exit;
	$hotelpromotions=$List->response_object;
}
			...
			<?php $i=0;		
				...
				<div class="row col-md-12"> 
					<div class="col-md-4" style="margin-top: 7px;">
						<span style="color:#727e8a">Name </span> : <?php $hrefurl =  $this->Url->build(array('controller'=>'users','action'=>'viewprofile',$hotelpromotion->user_id),1);?>
						<a href="<?php echo $hrefurl; ?>"> 
						<?php echo $hotelpromotion->user->first_name." ".$hotelpromotion->user->last_name;?></a>
					</div>
					<div class="col-md-4" style="margin-top: 7px;">
				...
				<td>
					...
					<a href="<?php echo $hrefurl; ?>"> 
					<?php echo $hotelpromotion->user->first_name." ".$hotelpromotion->user->last_name;?>
				</td>
				<td>
				...
				if ($user_id!=$hotelpromotion->user_id)
					{
						...
						{
						?>
					<a  class=" btn btn-danger btn-md"  data-target="#unfollow<?php echo $hotelpromotion->id; ?>" data-toggle="modal" >Unfollow</a>
					<?php }
					else{
						?>
				<a follow_id="<?php echo $hotelpromotion->user_id; ?>" class=" 
