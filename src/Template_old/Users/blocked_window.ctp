		...
		<div class="container-login100 bgdiv">
			<div class="wrap-login100 main_div prakash">
				...
				<div class="text-center p-t-90" style="padding-top: 20px;">
					...
					Dear User,</p>
					<p style="color:#ff9393; font-size:15px; text-align:left; margin-top:5px">					
					You are blocked by Administrator. Please Contact customer care of Travel B2B Hub.</p>
					<p style="color:#fff; font-size:17px; text-align:right;margin-top:5px">Travel B2B Team</p>
				</div>
				<div class="text-center p-t-90" style="padding-top: 20px;">
					<p style="color:#fff">Do you have another account?
						<a class="txt1"  style="color:#a9d4fa; font-size:15px" href="<?php echo $this->Url->build(array('controller'=>'users','action'=>'login')) ?>" style="color:#5ba7a4;">
							Sign In
						</a>
					</p>
				</div>
