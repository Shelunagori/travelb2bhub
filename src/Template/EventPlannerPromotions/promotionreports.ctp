					...
					<div class="col-md-6">
						...
						<div id="imagemodal<?php echo $eventplanner->id;?>" class="modal fade" role="dialog">
							...
							<div class="modal-content">
								...
								<?= $this->Html->image($eventplanner->full_image,['style'=>'width:100%;;padding:20px;padding-top:0px!important;']) ?>
								</div>
							</div>
							</div>
						</div>
		...
		<!------------------------- Renew Modal--------------------------->
						<div id="renew<?php echo $eventplanner->id; ?>" class="modal fade" role="dialog">
							<div class="modal-dialog modal-md" >
								...
								<input type="hidden" name="event_id" value="<?php echo $eventplanner->id; ?>">
								</form>
							</div>
						</div>
						<!------------------------- Remove Modal--------------------------->
