...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $eventPlannerPromotionCart->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $eventPlannerPromotionCart->id)]
            )
        ?></li>
...
<div class="eventPlannerPromotionCarts form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Event Planner Promotion Cart') ?></legend>
        <?php
