        ...
        <div class="col-md-12">
         <div class="box box-primary">
			<div class="box-header with-border">
              <h3 class="box-title">Finalized Requests Trend Lines</h3>
            </div>
			<div class="box-body">
			<form method="get" class="loadingshow">
					...
					<div class="col-md-3">
						<div class="form-group">
						  <label class="control-label col-md-12">&nbsp;</label>  
							<a href="<?php echo $this->Url->build(array('controller'=>'admins','action'=>'finalize-requests')) ?>"class="btn btn-danger btn-sm">Reset</a>
				...
				<div align="right" class="col-md-12" style="margin-bottom:5px"> 
					<form method="post" target="_blank">
						...
						<input type="hidden" value="Finalized_Requests_Report" name="file_name" />
...
$(function () {  
    $('#container').highcharts({
        title: {
            text: 'Monthly Finalized Requests',
            x: -20 //center
        },
        subtitle: {
