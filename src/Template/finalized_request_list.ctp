		...
		<div id="cat">
			<div class=" req col-lg-6 col-md-6 col-sm-12 col-xs-12" id="<?php if($request['category_id']==1){ echo "1";} if($request['category_id']==2){ echo "3";}if($request['category_id']==3){ echo "2";} ?>">
                <div class="box-event">
                    ...
                    <li class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <p>
                            <b>Agent Name :</b> <a href="viewprofile/<?php echo $finalresponse[$request['id']]; ?>/1"><?php echo str_replace(';',' ',$allUsers[$finalresponse[$request['id']]]); ?></a>
                        </p>
                     </li>
                     <li class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <p>
                            <b>Quotation Price :</b> Rs. <?php echo  $request['responses'][0]['quotation_price']; ?>
                        </p>
                    </li>
                    ...
                    <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 comment">
                        <p><b>Response Comment :</b> <span><?php echo $request['responses'][0]['comment']; ?></span></p>
                     </li>
                    </ul>
