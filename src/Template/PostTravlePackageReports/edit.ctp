...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $postTravlePackageReport->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $postTravlePackageReport->id)]
            )
        ?></li>
...
<div class="postTravlePackageReports form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Post Travle Package Report') ?></legend>
        <?php
