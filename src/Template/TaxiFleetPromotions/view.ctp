					...
					<div class="box-body">
						<table class="table" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<td>sdfsdfsd<?= $this->Number->format($taxiFleetPromotion->document) ?></td>
							</tr>
							<tr style="background-color:#709090;color:white">
							...
							<tr>
								<td>Udaipur<?php // h($taxiFleetPromotion->taxi_fleet_promotion_cities->city_id); ?></td>
								<td>Rajasthan<?php //= $this->Number->format($taxiFleetPromotion->state_id) ?></td>
							</tr> 
							<tr style="background-color:#709090;color:white">
