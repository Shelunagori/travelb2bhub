					...
					<div class="col-md-12">
						...
						<div class="col-md-12"><hr></hr></div>
							...
							<div class="col-md-12" align="center">
								<a href="<?php echo $this->Url->build(array('controller'=>'Users','action'=>'blockreport')) ?>"class="btn btn-danger btn-sm">Reset</a>
...
<div id="deletemodal<?php echo $user->id; ?>" class="modal fade" role="dialog">
	<div class="modal-dialog modal-md" >
		<form method="post" action="<?php echo $this->Url->build(array('controller'=>'Users','action'=>'blockdelete',$user->id)) ?>">
...
<div id="unvBlock<?php echo $user->id; ?>" class="modal fade" role="dialog">
	<div class="modal-dialog modal-md" >
		<form method="post" action="<?php echo $this->Url->build(array('controller'=>'Users','action'=>'blockedadminUnBlockUser',$user->id)) ?>">
			<div class="modal-content">
			  <div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">
