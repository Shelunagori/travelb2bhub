				...
				<legend style="color:#369FA1;"><b>STAY REQUIREMENTS:</b></legend>
					  <div class="row">
							<div class="col-md-12">
								...
								<div class="col-lg-2">
									<p>Single</p>
									<?php echo $this->Form->control('room1', ["id"=>"room1", "type"=>"number","min"=>0, "class"=>"form-control", 'label' => false, 'div' => false, "placeholder"=>"0"]); ?>
								</div>
								<div class="col-lg-2">
									<p>Double</p>
									<?php echo $this->Form->control('room2', ["id"=>"room2", "type"=>"number","min"=>0, "class"=>"form-control", 'label' => false, 'div' => false, "placeholder"=>"0"]); ?>
								</div>
								<div class="col-lg-2">
									<p>Tripple</p>
									<?php echo $this->Form->control('room3', ["id"=>"room3", "type"=>"number","min"=>0, "class"=>"form-control", 'label' => false, 'div' => false, "placeholder"=>"0"]); ?>
								</div>
								<div class="col-lg-2">
									<p>Child with Bed</p>
									<?php echo $this->Form->control('child_with_bed', ["id"=>"child_with_bed", "type"=>"number","min"=>0, "class"=>"form-control", 'label' => false, 'div' => false, "placeholder"=>"0"]); ?>
								</div>
								<div class="col-lg-2">
									<p>Child without Bed</p>
									<?php echo $this->Form->control('child_without_bed', ["id"=>"child_without_bed", "type"=>"number","min"=>0, "class"=>"form-control", 'label' => false, 'div' => false, "placeholder"=>"0"]); ?>
								</div>
							</div>
						</div>
						<div class="row">
