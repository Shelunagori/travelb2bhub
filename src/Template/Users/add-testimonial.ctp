...
<div class="container-fluid" id="profile" >
	...
	echo $this->Form->create("Promotions", ['type' => 'file', 'class'=> 'form-horizontal', 'url' => ['controller' => 'Users', 'action' => 'addtestimonial',$authoruserId], 'onSubmit' => 'return addtestimonial();', 'id'=>"addtestimonial"]); ?>
                        <fieldset class="promotion_form margin-b50" style=" box-shadow: none;">
								<!-- Text input-->
                          ...
                          <div class="col-md-5 margin_t20_on_mob" style="display: inline-block; width: 252px;">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group margin-t30 margin-b15 text-center">
                              <ul class="btn_on_prmotion"> 
                                  <li>
                                      <input type="submit" name="submittestimonial" id="submittestimonial" class="btn btn-primary btn-block" value="Submit ">
                                  </li>
