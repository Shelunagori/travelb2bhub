		...
		<fieldset style="background-color:#fff;">
				<div class="row col-md-12" style="padding:25px;">						
					...
					<div class="col-md-4">
						...
						<label><button type="button" class="btn btn-info btn-lg btnlayout" data-target="#renew<?php echo $postTravlePackage->id; ?>" data-toggle=modal>Renew</button></label>
						</div>
						<!------------------------- Renew Modal--------------------------->
						...
						<div class="row col-md-12">
						<label>
						<button type="button" class="btn btn-danger btn-lg btnlayout" data-target="#remove<?php echo $postTravlePackage->id; ?>" data-toggle=modal>Remove</button>
						</label>
						</div>
						<!------------------------- Remove Modal--------------------------->
