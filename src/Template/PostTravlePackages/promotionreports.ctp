			...
			<form method="post" class="formSubmit">
				<div class="row col-md-12" style="padding:25px;">						
					...
					<div class="col-md-4">
						...
						<label><button type="button" class="btn btn-info btn-lg btnlayout" data-target="#renew<?php echo $postTravlePackage->user_id; ?>" data-toggle=modal>Renew</button></label>
						</div>
						<!------------------------- Renew Modal--------------------------->
						<div id="renew<?php echo $postTravlePackage->user_id; ?>" class="modal fade" role="dialog">
							<div class="modal-dialog modal-md" >
								<!-- Modal content-->
									<div class="modal-content">
						...
						<div class="row col-md-12">
						<label>
						<button type="button" class="btn btn-danger btn-lg btnlayout" data-target="#remove<?php echo $postTravlePackage->user_id; ?>" data-toggle=modal>Remove</button>
						</label>
						</div>
						<!------------------------- Remove Modal--------------------------->
						<div id="remove<?php echo $postTravlePackage->user_id; ?>" class="modal fade" role="dialog">
							<div class="modal-dialog modal-md" >
								<!-- Modal content-->
									<div class="modal-content">
						...
						<div class="row col-md-12">
						<label><button type="button" class="btn btn-warning btn-lg btnlayout" data-target="#details<?php echo $postTravlePackage->user_id; ?>" data-toggle=modal>Details</button></label>
						</div>
						<!------------------------- Details Modal--------------------------->
						<div id="details<?php echo $postTravlePackage->user_id; ?>" class="modal fade" role="dialog">
							<div class="modal-dialog modal-md" >
								<!-- Modal content-->
									<div class="modal-content">
									  <div class="modal-header" >
