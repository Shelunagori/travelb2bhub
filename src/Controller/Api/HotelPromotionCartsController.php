...
class HotelPromotionCartsController extends AppController
{
	...
	public function HotelPromotionCartlist($user_id=null)
	{
		...
		if(!empty($user_id))
		{
			$hotelPromotionCarts=$this->HotelPromotionCarts->find()->where(['HotelPromotionCarts.user_id'=>$user_id, 'HotelPromotionCarts.is_deleted'=>0,'HotelPromotions.is_deleted'=>0,'HotelPromotions.visible_date >='=>date('Y-m-d')])->contain(['HotelPromotions'=>['HotelCategories','Users'=>function($q){
