...
class PostTravlePackageCartsController extends AppController
{
	...
	public function postTravlePackageCartlist($user_id=null)
	{
		...
		if(!empty($user_id))
		{
			$postTravelPackageCarts=$this->PostTravlePackageCarts->find()->where(['PostTravlePackageCarts.user_id'=>$user_id, 'PostTravlePackageCarts.is_deleted'=>0])->contain(['PostTravlePackages','Users']);
