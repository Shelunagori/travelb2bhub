...
class TaxiFleetPromotionCartsController extends AppController
{
	...
	public function TaxiFleetPromotionsCartlist($user_id=null)
	{
		...
		if(!empty($user_id))
		{
			$taxiFleetPromotionCarts=$this->TaxiFleetPromotionCarts->find()->where(['TaxiFleetPromotionCarts.user_id'=>$user_id, 'TaxiFleetPromotionCarts.is_deleted'=>0,'TaxiFleetPromotions.is_deleted'=>0])->contain(['TaxiFleetPromotions'=>['Users'=>function($q){
