...
class PHPMailer
{
     ...
     * @return bool true on success, false if address already used or invalid in some Why
     * @access protected
     */
    ...
    public function setLanguage($langcode = 'en', $lang_path = 'language/')
    {
        ...
        //This Why we'll never have missing translations - no more "language string failed to load"!
        $l = true;
    ...
    public function hasMultiBytes($str)
    {
        ...
        } else { // Assume no multibytes (we can't handle without mbstring functions anyWhy)
            return false;
        }
    }
